...
export default function CGPAForecastPage() {
  ...
  const simData = useMemo(() => {
    ...
    // Smart Assistant Logic: Calculate exactly what is needed to hit the target
            ...
            <div className="xl:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-3xl p-6 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] border border-gray-100">
                ...
                <div className="mb-4">
                  ...
                  <input type="number" step="0.01" value={targetCgpa} onChange={(e)=>setTargetCgpa(Number(e.target.value))} className="w-full text-xl font-bold text-gray-900 border border-gray-200 rounded-xl px-4 py-2 focus:ring-2 focus:ring-indigo-500 outline-none" />
                </div>
              ...
              <div className="bg-[#5b51e5] rounded-3xl p-6 text-white shadow-lg relative overflow-hidden">
                ...
                <p className="text-[15px] font-medium leading-relaxed mb-6">
                  To reach your goal of <span className="font-extrabold text-white underline decoration-2 underline-offset-2">{targetCgpa.toFixed(2)}</span>, you need a minimum GPA of <span className="font-extrabold text-white underline decoration-2 underline-offset-2">{simData.requiredGpa.toFixed(2)}</span> in your upcoming semester.
                </p>
            ...
            <div className="xl:col-span-2 flex flex-col gap-6">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] border border-gray-100 flex-1">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <button className="bg-indigo-50 text-indigo-600 font-bold text-xs px-4 py-2 rounded-lg hover:bg-indigo-100 transition">
                    + Add Course
                  </button>
                </div>
                ...
                <div className="space-y-3 mb-8">
                  {courses.map(course => (
                    <div key={course.id} className="grid grid-cols-12 items-center text-sm font-semibold border-b border-gray-50 pb-3 px-2">
                      <div className="col-span-5 text-gray-800">{course.name}</div>
                      <div className="col-span-2 text-center text-gray-500">{course.credits.toFixed(1)}</div>
                ...
                <div className="flex flex-wrap items-end justify-between pt-4 gap-4">
                  ...
                  <div className="flex gap-3 items-center">
                    ...
                    <button className="border-2 border-gray-200 text-gray-600 font-bold py-2.5 px-5 rounded-xl text-sm hover:border-gray-300 transition">
                      Clear Simulation
                    </button>
                    <button onClick={handleApplyPlanner} className="bg-[#0f172a] hover:bg-gray-800 text-white font-bold py-2.5 px-6 rounded-xl text-sm shadow-md transition">
                      Apply to Planner
                    </button>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] border border-gray-100">
                ...
                <div className="flex items-end justify-between h-32 px-4 border-b-2 border-gray-50 pb-2">
                   {/* Dummy historical data bars to match the visual */}
                   ...
                   <div className="w-1/6 flex flex-col items-center gap-2">
                      ...
                      <span className="text-[10px] font-bold text-gray-800">Sem 4 (Now)</span>
                   </div>

                   {/* Target / Projected Bar */}
                   <div className="w-1/6 flex flex-col items-center gap-2">
                      ...
                      <span className="text-[10px] font-bold text-indigo-600">Target</span>
                   </div>
                </div>
              </div>
            </div>
