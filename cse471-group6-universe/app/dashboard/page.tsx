      ...
      <div className="max-w-7xl mx-auto w-full space-y-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm hover:shadow-md transition flex flex-col justify-between group">
              <div><div className="w-12 h-12 bg-rose-50 text-rose-600 rounded-2xl flex items-center justify-center font-bold mb-6 group-hover:bg-rose-600 group-hover:text-white transition">📅</div><h3 className="text-xl font-bold text-gray-900 mb-2">Assignment & Quiz Scheduler</h3><p className="text-sm text-gray-500 font-medium leading-relaxed mb-6">Track upcoming work, see live deadline countdowns, and receive browser reminders before quizzes and submissions are due.</p></div>
              <Link href="/scheduler" className="w-full bg-[#0f172a] hover:bg-gray-800 text-white font-bold py-3.5 px-6 rounded-2xl text-xs flex items-center justify-center gap-2 transition shadow-md">Open Deadline Tracker →</Link>
            </div>
